...
export function registerListAssets(server: McpServer, apiKey: string) {
  server.tool(
    "list_assets",
    "List all supported assets (stocks, crypto, ETFs) with their ticker symbols and asset classes. Use this to check if a specific ticker is available before calling other tools. No rate limit.",
    {},
    async () => {
